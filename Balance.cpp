...
void balance()
{
  ...
  // Paul commented this out before
  motorSpeed += (
...
void lyingDown()  //Has been stifled so as to stop killing Rupert
{
  ...
  if (angleRate > -2 && angleRate < 2)
  {
    ...
    if (imu.a.z > 0)
    {
      ...
      // We have recalibrated this angle to account for differences between robots.
      angle = 88000;
